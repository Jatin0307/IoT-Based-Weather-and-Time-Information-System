...
#define TFT_RST    22
#define TFT_DC     21
Adafruit_ST7735 tft = Adafruit_ST7745(TFT_CS, TFT_DC, TFT_RST);

// === Config ===
const char* ssid = "Jatin's phone";
const char* password = "Jatin@82";
const char* weatherApiKey = "e9735fb5da6ec9c52acb1e5e18c7e3ad";
const char* weatherCity = "Delhi";
